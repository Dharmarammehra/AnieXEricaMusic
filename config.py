...
GBAN_LOGS = int(getenv("GBAN_LOGS", "-1002138343949"))
GCAST_USERS = list(map(int, getenv("GCAST_USERS", "6648816133 6331417894").split()))
OWNER_ID = int(getenv("OWNER_ID", 6648816133))
OWNER = int(getenv("OWNER", 6648816133))
OWNER_USERNAME = getenv("OWNER_USERNAME","The_stoic_mehra")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/Dharmarammehra/AnieXEricaMusic")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN",None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Love_and_sad_thoughts_video")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Love_and_sad_thoughts_video")
